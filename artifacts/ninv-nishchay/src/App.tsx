...
const DEFAULT_EVENTS = [
  ...
  },
  {
    ...
    date: "2026-06-22",
    image: "https://www.arohanagpur.org/wp-content/uploads/2022/08/skills-004.jpg",
...
function Programs() {
  const programs = [
    ...
    },
    {
      ...
      image: "https://www.smilefoundationindia.org/blog/wp-content/uploads/2024/03/jpeg-optimizer_Over-5000-hand-holding-sessions-conducted-with-community-based-NGOs-in-more-than-950-villages-across-25-states-in-India-within-a-year.jpg",
      tag: "Community",
      flagship: false,
    },
    {
